...
export const ephecActivities = [
  ...
  { 
    ...
    activity: "Réalisation complète d'un tutoriel React Native avec Expo", 
    hours: 10,
    link: "",
    repo: "",
    analysis: {
      cadre: "Suite à ma participation à une Summer School internationale à Toronto axée sur la création d'une application mobile (le projet Bookworm), j'ai ressenti le besoin de prendre du recul pour approfondir et consolider les technologies que nous avions utilisées. J'ai donc décidé de suivre un tutoriel complet et détaillé sur React Native et l'écosystème Expo, reprenant les concepts à mon propre rythme en totale autonomie.",
      faits: "Au-delà de la révision de la syntaxe et de l'architecture des composants, l'un des aspects les plus marquants de cet apprentissage a été la découverte approfondie d'Expo Go. J'ai trouvé extrêmement intéressant et stimulant de pouvoir tester, recharger et visualiser l'application en temps réel directement sur mon propre téléphone. Interagir avec mon code via les capteurs et l'interface d'un appareil mobile physique a apporté une dimension beaucoup plus concrète au développement.",
  ...
  { 
    ...
    repo: "",
    analysis: {
      cadre: "Au cours de l'année académique 2025-2026, je me suis porté volontaire pour assumer une fonction de tuteur bénévole au sein de l'EPHEC. L'objectif était de venir en aide aux étudiants de première année de bachelier nécessitant un soutien dans leur apprentissage. Dans ce cadre institutionnel, j'ai eu l'opportunité d'accompagner une étudiante, spécifiquement sur le cours de mathématiques, pour un total de 7,5 heures de prestations officielles.",
